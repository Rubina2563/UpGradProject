...
const WithdrawMoney = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      ...
      .then((res) => {
       enqueueSnackbar('Withdrawal added successfully!', { variant: 'success' });
        dispatch(loadSeller());
        setBankInfo({
          bankName: "",
          bankCountry: "",
  ...
  const deleteHandler = async () => {
    await axios
      ...
      .then((res) => {
        enqueueSnackbar('Withdrawal deleted successfully!', { variant: 'success' });
        dispatch(loadSeller());
      });
  };

  const error = () => {
    enqueueSnackbar("don'thave enough balance", { variant: 'error' });
  };

  const withdrawHandler = async () => {
    if (withdrawAmount < 50 || withdrawAmount > availableBalance) {
      enqueueSnackbar("Can't withdraw this amount", { variant: 'error' });
    } else {
      ...
      await axios
        ...
        .then((res) => {
           enqueueSnackbar('Withdraw money processed successfully!', { variant: 'success' });
        });
    }
  };
