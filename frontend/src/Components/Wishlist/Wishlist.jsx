...
*/
  ...
  return (
    <div className="fixed top-0 left-0 w-full  bg-[#0000004b] h-screen z-10">
      <div className="fixed top-0 right-0 h-full w-[40%] overflow-y-scroll 800px:w-[25%] bg-white flex flex-col justify-between shadow-sm">
            ...
            <div>
              ...
              <div className={`flex items-center p-4`}>
                ...
                <h5 className="pl-2 text-[20px] font-[500]">
                  {/*wishlist && wishlist.length*/}3 items
                </h5>
              </div>
