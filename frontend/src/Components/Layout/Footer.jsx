    ...
    <div className="bg-black text-white">
      <div className="md:flex md:justify-between md:items-center sm:px-12 px-4 bg-[#342ac8] py-7">
        <h1 className="lg:text-4xl text-3xl md:mb-0 mb-6 lg:leading-normal font-semibold md:w-2/5">
          <span className="text-[#56d879]">Contact</span> us for {" "}
          <br />
         any question ....
        </h1>
        <div>
     ...
     <h1 className="m-5 lg:w-1/2 font-extrabold text-blue-800 sm:text-1xl lg:text-2xl  text-center bg-gray-100 p-4 shadow-lg rounded-lg">
  ShopPlusPlus
</h1>
          <br />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 text-center pt-2 text-gray-400 text-sm pb-8">
        <span>© ShopPlusPlus. All rights reserved.</span>
