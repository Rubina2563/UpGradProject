...
const Cart = ({ setOpenCart }) => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full bg-[#0000004b] h-screen z-10">
      <div className="fixed top-0 right-0 h-full w-[80%] md:w-[50%] bg-white flex flex-col overflow-y-scroll justify-between shadow-sm">
        {loading ? (
          <div className="w-full h-screen flex items-center justify-center">
            <h5>Loading...</h5>
          </div>
        ) : cart && cart.length === 0 ? (
          <div className="w-full h-screen flex items-center m-10 justify-center">
